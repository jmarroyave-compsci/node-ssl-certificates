...
function getCertificateInfo(pem) {
  ...
  resp;
  resp.infoAccess = {
    "CA Issuers": "URI:" + n.sub[7].sub[0].sub[6].sub[1].sub[0].sub[0].sub[1].content().split("\n")[1],
    "OCSP": "URI:" + n.sub[7].sub[0].sub[6].sub[1].sub[0].sub[1].sub[1].content().split("\n")[1],
  };
